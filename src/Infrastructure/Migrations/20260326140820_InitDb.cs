        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ConversationMemberId = table.Column<long>(type: "bigint", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    MessageId = table.Column<long>(type: "bigint", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    Emotion = table.Column<string>(type: "text", nullable: true),
                    IsInvoked = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MemberMessages_ConversationMembers_ConversationMemberId",
                        column: x => x.ConversationMemberId,
                        principalTable: "ConversationMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MemberMessages_Messages_MessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberMessages_ConversationMemberId",
                table: "MemberMessages",
                column: "ConversationMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_MemberMessages_MessageId",
                table: "MemberMessages",
                column: "MessageId");

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hometown = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Website = table.Column<string>(type: "TEXT", nullable: true),
                    RelationshipStatus = table.Column<short>(type: "SMALLINT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlockChats", x => new { x.UserId, x.BlockedUserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverPhotoUrl = table.Column<string>(type: "TEXT", nullable: true),
                    IsPostApprovalRequired = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    IsGroupJoinApprovalRequired = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    AllowAnonymousPost = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Degree = table.Column<short>(type: "SMALLINT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TextPositionX = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    TextPositionY = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReactionUserId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ForwardFromMessageId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeelingActivity = table.Column<string>(type: "text", nullable: true),
                    ApprovalStatus = table.Column<byte>(type: "SMALLINT", nullable: false, defaultValue: (byte)0),
                    IsHiddenFromGroup = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoryReactions", x => x.ReactionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReactionType = table.Column<byte>(type: "SMALLINT", nullable: false),
                    CommentId = table.Column<long>(type: "bigint", nullable: false),
                    PostCommentId = table.Column<long>(type: "bigint", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlockChats_BlockedUserId",
                table: "BlockChats",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostComments_RepliedUserId",
                table: "PostComments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoryReactions_UserId_StoryId",
                table: "StoryReactions",
